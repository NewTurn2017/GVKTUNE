...
package com.gvkorea.gvktune.analyzer;
...
import com.gvkorea.gvktune.util.MovingAverage;
...
public class AnalyzerViews {
    ...
    public AnalyzerViews(AnalyzerActivity _activity) {
        activity = _activity;
...
//                popupMenuAverage.showAsDropDown(view, 0, 0);
    ...
    private void refreshRMSLabel(double dtRMSFromFT) {
        ...
        SBNumFormat.fillInNumFixedWidth(textRMS, 20* Math.log10(dtRMSFromFT)+115.4, 3, 1);
        ...
        tv.invalidate();
//        if(activity.rmsValues != null){
//            TextView test = (TextView) activity.findViewById(R.id.test);
//            test.setText(Arrays.toString(activity.rmsValues));
//            test.invalidate();
//        }
    }
