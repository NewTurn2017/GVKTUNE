package com.gvkorea.gvktune.view.view.data.util.audio
...
import com.gvkorea.gvktune.view.view.data.DataFragment.Companion.averageCount
import com.gvkorea.gvktune.view.view.data.DataFragment.Companion.octaveStarted31
import kotlinx.android.synthetic.main.fragment_data.view.*
import java.text.DecimalFormat
import kotlin.math.log10
import kotlin.math.pow

class RecordAudioRTA_31(var barChart: BarChart, var view: View) :
    ...
    override fun onProgressUpdate(vararg values: DoubleArray) {
        ...
        for (i in 1 until toTransformAvg.size) {
            ...
            if (arrayNum == 31) {
                spldB31 = Math.round(calculate_SPL(rmsValues31) * 10) / 10.0
                view.tv_curSPL.text = spldB31.toString()
